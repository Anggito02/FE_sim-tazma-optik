...
class FrameController extends Controller
{
    public function getAllFrameCategory(){
        ...
        $response = Http::withHeaders($headers)->get('http://localhost:8001/api/frame-category/all', $api_request);
    ...
    public function addFrameCategory(Request $request)
    {
        ...
        $response = Http::withHeaders($headers)->post('http://localhost:8001/api/frame-category/add', $api_request);
    ...
    public function updateFrameCategory(Request $request)
    {
        ...
        $response = Http::withHeaders($headers)->put('http://localhost:8001/api/frame-category/edit', $api_request);
    ...
    public function deleteFrameCategory(Request $request)
    {
        ...
        $response = Http::withHeaders($headers)->delete('http://localhost:8001/api/frame-category/delete', $api_request);
