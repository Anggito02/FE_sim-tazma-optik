...
<div class="container-fluid">
    ...
    <!-- DataTales Example -->
    <div class="mb-4">
        <a href="/branch-outgoing"><i class="fa-solid fa-arrow-left"></i> Back</a>
    </div>
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between p-5 black-text">
                <div class="d-flex flex-column">
                    ...
                    <h3>{{$branch_outgoing['nomor_outgoing']}}</h3>
                    <h3><br></h3>
                    <h3>Tanggal Outgoing:</h3>
                    <h3>{{$branch_outgoing['tanggal_outgoing']}}</h3>
                    <h3><br></h3>
                    <h3>Tanggal Pengiriman:</h3>
                    <h3>{{$branch_outgoing['tanggal_pengiriman']}}</h3>
                </div>
                <div class="d-flex flex-column align-items-end">
                    <p>Known By: {{$branch_outgoing['known_by_name']}}</p>
                    <p>Checked By: {{$branch_outgoing['checked_by_name']}}</p>
                    <p>Approved By: {{$branch_outgoing['approved_by_name']}}</p>
                </div>
            </div>

            <div class="d-flex justify-content-between p-5 black-text">
                <div class="d-flex flex-column">
                    <h3>Cabang asal - Cabang tujuan:</h3>
                    <h3>{{$branch_outgoing['nama_branch_from']}} - {{$branch_outgoing['nama_branch_to']}}</h3>
                </div>

                <div class="d-flex flex-column align-items-end"> 
                    <p>Delivered By: {{$branch_outgoing['delivered_by_name']}}</p>
                    @if ($branch_outgoing['received_by'] == 0)
                    <p>Received By: <span class="badge badge-danger">Belum Diterima</span></p>
                    @else
                    <p>Received By: {{$branch_outgoing['received_by_name']}}</p>
                    @endif
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        @foreach ($branch_outgoing_detail as $valIod)
                        <tr>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form action="/branch-outgoing/detail/verify" method="post">
                                                    @csrf
                                                    @method("PUT")
                                                    <input type="hidden" name="id" value="{{$valIod['id']}}">
                                                    <input type="hidden" name="branch_outgoing_id" value="{{$valIod['branch_outgoing_id']}}">
                                ...
                                <div class="modal fade" id="exampleModalCenterEdit{{$valIod['id']}}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body black-text">
                                                <form method="post" action="/branch-outgoing/detail/edit">
                                                    @csrf
                                                    @method("PUT")
                                                    <div class="row">
                                                        <div class="col">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select name="branch_from_id" class="form-control chosen-select">
                                                                    <option value="{{$branch_outgoing['branch_from_id']}}" hidden selected>{{$branch_outgoing['nama_branch_from']}}</option>
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select name="branch_to_id" class="form-control chosen-select">
                                                                    <option value="{{$branch_outgoing['branch_to_id']}}" hidden selected>{{$branch_outgoing['nama_branch_to']}}</option>
                                                                    @foreach ($branch as $val)
                                                                    <option value="{{$val['id']}}">{{$val['nama_branch']}}</option>
                                                                    @endforeach
                                                                </select>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer black-text">
                                                ...
                                                <form method="post" action="/branch-outgoing/detail/delete">
                                                    @csrf
                                                    @method("DELETE")
                                                    <input type="hidden" name="id" value="{{$valIod['id']}}">
                                                    <input type="hidden" name="branch_outgoing_id" value="{{$valIod['branch_outgoing_id']}}">
    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body black-text">
                    <form method="post" action="/branch-outgoing/detail/add">
                        @csrf
                        @method("POST")
                        <div class="row">
                            <div class="col">

                                <input type="hidden" name="branch_outgoing_id" value="{{$branch_outgoing['id']}}">
