    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-striped" style="table-layout:fixed; width:100%; border-collapse:collapse;" id="data_retur_table_1" width="100%" cellspacing="0">
                    <thead class="thead-color txt-center">
                        <tr style="white-space: nowrap;">
                            <th class="thead-text" style="width: 10%;"><span class="nowrap">No</span></th>
                            <th class="thead-text" style="width: 35%;"><span class="nowrap">Nomor Retur</span></th>
                            <th class="thead-text" style="width: 35%;"><span class="nowrap">Tanggal Retur</span></th>
                            <th class="thead-text" style="width: 35%;"><span class="nowrap">Tanggal Pengiriman</span></th>
                            <th class="thead-text" style="width: 25%;"><span class="nowrap">Cabang</span></th>
                            <th class="thead-text" style="width: 20%;"><span class="nowrap">Checked by</span></th>
                            <th class="thead-text" style="width: 20%;"><span class="nowrap">Approved by</span></th>
                            <th class="thead-text" style="width: 20%;"><span class="nowrap">Delivered by</span></th>
                            <th class="thead-text" style="width: 20%;"><span class="nowrap">Received by</span></th>
                            <th class="thead-text" style="width: 10%;"><span class="nowrap">Details</span></th>
                            <th class="thead-text" style="width: 10%;"><span class="nowrap">Edit</span></th>
                            <th class="thead-text" style="width: 10%;"><span class="nowrap">Delete</span></th>
                        </tr>
                    </thead>
...
<script type="text/javascript">
        ...
        if(loading == false && end_record == false){
            ...
            $.ajax({
                ...
                success : function(result){
					...
					var table = $('#data_retur_table_1').DataTable();
                    let rowData = [];
                    for(let i=0; i<result.data.length; i++){
                        ...
                        rowData.push([
							offsetN0,
                            currentItem.nomor_retur,
                            currentItem.tanggal_retur,
    ...
    function masterContent() {
		var settings = $.extend({
            ...
            data_url: "{{ url('/retur/loadDataMaster') }}",
    ...
    function handleButtonClick(id) {
        window.location.href = "/retur/detail/"+id;
    }
    ...
    function handleButtonEditClick(id) {
        ...
        $.ajax({
		    url   : "{{ url('/retur/loadDataDetailOnly')}}",
		    data 	:{'id':id},
		    method	: "POST",
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">New Retur</h5>
