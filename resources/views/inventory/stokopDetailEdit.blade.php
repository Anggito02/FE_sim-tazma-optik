...
<div class="modal-body">
    <!-- <form method="post" action="/item/edit"> -->
        @foreach ($stock_opname_detail as $val)
            <form id="edit_info" class="form-horizontal"> 
                @csrf
                <!-- @method("PUT") -->
                <input type="hidden" readonly=true name="id" class="form-control" value="{{$detail_id}}">
                <input type="hidden" readonly=true name="stock_opname_id" class="form-control" value="{{$val['id'][]}}">
                <div class="row">
                    <div class="col">
