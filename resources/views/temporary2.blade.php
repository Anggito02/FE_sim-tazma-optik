        ...
        <form id="itemForm" action="/stock_opname_branch/detail/" method="POST" class="col-md-12 form-horizontal">
            <div class="card-body">
                ...
                <div class="form-group col-md-3">
                    <label for="tanggal_so_from" class="form-label black-text">SO Start</label>
                    <input readonly=true type="date" name="tanggal_so_from" id="tanggal_so_from" class="form-control" value="{{ now()->format('d/m/Y') }}">
                </div>
                <div class="form-group col-md-3">
                    <label for="adjustment_type" class="form-label black-text">Adjust Quantity</label>
                    <input type="text" name="adjust_quantity" id="adjust_quantity" class="form-control">
                </div>
                <div class="form-group col-md-3">
                    <label for="adjustment_date_from" class="form-label black-text">Open By</label>
                    <input readonly=true type="text" name="open_by" id="open_by" class="form-control" value="">
                </div>
                <div class="form-group col-md-3">
                    <label for="adjustment_date_from" class="form-label black-text">Item</label>
                    <input type="text" name="open_by" id="open_by" class="form-control" value="">
                </div>
                <div class="form-group col-md-12">
                    <br/>
                    <button type="button" class="btn btn-success" type="submit">Submit</button>
                </div>
            </div>
        </form>
    </div>
