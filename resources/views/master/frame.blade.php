                ...
                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        @foreach ($frame as $val)
                            <tr>
                                <input type="hidden" id="id" name="frame_id" class="form-control"
                                    value="{{ $val['id'] }}">
                                <div class="d-none">
                                  {{ $id = $val['id'] }}
                                </div>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="post" action="/frame-category/edit">
                                                    @csrf
                                                    @method("put")
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form method="post" action="/frame-category/delete">
                                                    @csrf
                                                    @method("DELETE")
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="/frame-category/add">
                    @csrf
                    @method("POST")

                    <div class="mb-3 black-text">
                        <label for="InputWarna" class="form-label">Nama Frame</label>
                        <input type="text" id="frame_nama" name="frame_nama" class="form-control">
                    </div>
