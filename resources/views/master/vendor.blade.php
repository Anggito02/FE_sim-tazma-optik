                ...
                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                    <thead class="thead-color">
                        <tr>
                            ...
                            <th class="thead-text"><span class="nowrap">No Telp Vendor</span></th>
                                                            ...
                                                            <div class="row">
                                                                <div class="col">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <div><input type="text" id="InputTelpVendor"
                                                                                name="TelpVendor" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="col">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <div><input type="text" id="InputNPWP"
                                                                                name="NPWP" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <div><input type="text" id="InputStatus"
                            ...
                            <div class="row black-text">
                                ...
                                <div class="col">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div><input type="text" id="InputNPWP" name="NPWP" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div><input type="text" id="InputStatus" name="Status" class="form-control">
                                        </div>
                                    </div>
