    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col">
                    <div>
                        <label for="InputSection" class="form-label">Position</label>
                        <select type="section" class="form-select form-control" id="InputSection">
                ...
                <div class="col">
                    <div>
                        ...
                        <select type="role" class="form-select form-control" id="InputRole">
                ...
                <div class="col">
                    <div>
                        ...
                        <input type="plant" class="form-control" id="InputPlant">
                    </div>
                </div>
                <div class="col">
